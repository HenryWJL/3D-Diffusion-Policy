...
python eval.py --config-name=dp3.yaml task=robosuite_lift training.device="cpu" ckpt_path=/Users/wangjl/Desktop/Projects/3D-Diffusion-Policy/3D-Diffusion-Policy/checkpoints/3000.pth
