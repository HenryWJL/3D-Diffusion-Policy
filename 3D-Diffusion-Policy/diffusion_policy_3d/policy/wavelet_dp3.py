...
from diffusion_policy_3d.model.diffusion.transformer import DualNoisePredictionNet
...
class WaveletDP3(BasePolicy):
    ...
    def compute_loss(self, batch):
        ...
        low_freq, high_freq = self.dwt(trajectory.transpose(2, 1))
        low_freq = low_freq.transpose(2, 1)
        high_freq = high_freq.transpose(2, 1)
