...
import torch
import numpy as np
from diffusion_policy_3d.flow_matching import utils as mutils
...
class ConsistencyFM():
    ...
    def ode(self, init_input, model, reverse=False):
      ...
      from diffusion_policy_3d.flow_matching.utils import from_flattened_numpy, to_flattened_numpy, get_score_fn
